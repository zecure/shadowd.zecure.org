 ...
 * https://shadowd.zecure.org/files/shadowd_ui-1.2.0.tar.gz
 * https://shadowd.zecure.org/files/shadowd_ui-1.2.0.tar.gz.DIGESTS
 * https://shadowd.zecure.org/files/shadowd_ui-1.2.0.tar.gz.DIGESTS.asc
